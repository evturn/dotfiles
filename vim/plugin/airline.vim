...
let g:airline#themes#dark#palette.normal_modified   = { 'airline_c': [ group[0], '', group[2], '', '' ] }
...
let g:airline#themes#dark#palette.inactive_modified = { 'airline_c': [ group[0], '', group[2], '', '' ] }
...
let g:airline#themes#dark#palette.normal.airline_term  = [ s:TE[0], s:TE[1], s:TE[2], s:TE[3] ]
let g:airline#themes#dark#palette.insert.airline_term  = g:airline#themes#dark#palette.normal.airline_term
let g:airline#themes#dark#palette.visual.airline_term  = g:airline#themes#dark#palette.normal.airline_term
